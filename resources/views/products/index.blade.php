        ...
        <div class="col-xs-12">
            <div class="widget-box">
                <div class="widget-header">
                    @include('products.partial.addButton')
                </div>
                    ...
                    <div class="widget-main">
                        ...
                        <table id="list-table" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                @if( $templateUser->is_system_user || in_array('change_products', $templatePermissions) || in_array('delete_products', $templatePermissions) )
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        @if( $templateUser->is_system_user || in_array('change_products', $templatePermissions) || in_array('delete_products', $templatePermissions))
                                            ...
                                            <td>
                                                @if( $templateUser->is_system_user || in_array('change_products', $templatePermissions) )
