...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<meta charset="utf-8" />
		<title>Electoral Commission - @yield('title')</title>

		<meta name="description" content="" />
		<meta name="author" content="Electoral Commission">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Paharika Restaurant</span> &copy; <?php echo Date('Y') ?>
						</span>
